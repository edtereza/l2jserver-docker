...
appReebok.onPageAfterAnimation('*', function(page) {
	
	if(page.name === 'geocomplete') {
		appReebok.params.fastClicksExclude = '^pac-';
	}
	else {
		appReebok.params.fastClicksExclude = '';
	}
...
*/
    ...
    var chip = $$(this).parents('.chip');
		if($$(this).hasClass('confirm')) {
			appReebok.confirm('Do you want to delete this?', function() {
				chip.remove();
			});
		}
		else {
